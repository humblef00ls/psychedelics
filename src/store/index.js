...
export const time_periods = [

    {
        ...
        bg: '/imgs/med_bg.jpeg',
        content: [
            'Our trail of the compound history of psychedelics starts in the Middle Ages in Europe. People of this time did not have a well defined relationship with psychedelics, and there is certainly speculation and theorising involved in connecting the dots. The first step here is to identify when these interactions took place. Firstly, we do know that some people used psychoactive substances such as mandrake, henbane, and deadly nightshade - belladonna (U.S. Forest Service) . All of these are highly toxic due to the presence of alkaloids such as scopolamine, atropine or hyoscyamine (Alonso et al.). Another important interaction people had with psychedelics was accidentally ingesting ergot (Lienhard) (Hagan), which contains psychoactive alkaloids including lysergic acid (LSD). The next question is how and why did these interactions come to be?',

            '$/imgs/med_img_1.jpeg@Mandragoras(Mandrake) in Dioscoridem Anazarbeum~https://no.pinterest.com/pin/570549846517083562/$/imgs/med_img_2.jpeg@Matthew Hopkins, Witchfinder general, with two supposed witches calling out the names of their demons, some of which are represented by animals. Etching, 1792, after an earlier woodcut.~https://wellcomecollection.org/works/jgd7dypv',

           'The first reason for the intentional use of psychedelics that we can find actual records about is "medicinal" (Lee.) (Pliny even documented its use by fortune tellers as far back as ancient Greece) (Pliny). Despite the toxicities, these plants were, and still are, used in the treatment of a variety of conditions. Psychoactive plants were used as love philtres, fertility boosters, and a lot of other ointments, fumigations, potions and concoctions . Here we start to see a very important theme, witchcraft. Known as the ‘witches plant’, henbane had great importance during the Middle Ages, being used by magicians and healers in ritual purifications by smoke as well as in the preparation of concoctions, most notably the ‘flying ointments’ (Alonso et al.). Flying ointments were documented as far back as the 13th century by people like the famous alchemist Albertus Magnus, who wrote about those using “black magic” using Henbane for their rites. It’s thanks to writings like his and others that we know what ingredients went into flying ointments in the middle ages, thus connecting our compound to witches (Mason). Exposure to this ointment, applied mainly to the armpits or the genital area, produced the sensation of flying. Administered rectally after smearing on a stick or pole, this is reputedly the reason why witches are often depicted as flying on broomsticks. Such practices were prosecuted by The Church and many witches were imprisoned, tortured and burnt at the stake  (Alonso et al.). It is theorized that despite being taken accidentally, even victims of ergot poisoning were persecuted by The Church. This was likely due to the similarities an observer would see between the symptoms of ergot poisoning and the symptoms of the other psychoactive substances. These included seizures, hallucinations and convulsions (Lienhard). Ergot Rye poisoning is also theorised to be the cause of the \'dancing mania\' that manifested in Europe (Saint Vitus dance) (Pennant-Rea). This association with witchcraft played a key role in the stigmatization of psychedelics. And so, to answer the question of how psychedelics came to be demonized, we have to answer the question: Why did The Church start hunting and demonizing witches?',

            '$/imgs/med_img_3.jpeg@Engraving portrays three women affected by the plague. Work based on original drawing by Pieter Brueghel, who supposedly witnessed a subsequent outbreak in 1518 in Flanders~https://en.wikipedia.org/wiki/Dancing_plague_of_1518#/media/File:Die_Wallfahrt_der_Fallsuechtigen_nach_Meulebeeck.jpg$/imgs/med_img_5.jpeg@Witches flying on broomsticks.~https://wellcomecollection.org/works/abkab8tq',

            'Strangely, the truth is that for a long time witchcraft was often viewed with skepticism, and witches of this era weren’t initially perceived as satanic. It wasn\'t until late the 1500s that the great \'witch hunt\' of Europe began (Guilford). There are two dominant theories about the motives and cause for the witch hunt. The first is about bad weather causing mass hysteria, and the second is about the economic rivalry between churches. Our focus will be on the latter since it is backed by quantifiable data. Until the 1500s, the Catholic Church had claimed a monopoly on religion. It labeled proponents of other religions “heretics” and either forced their conversion or simply killed them, using inquisitions and crusades. Protestantism emerged as the first truly viable challenger to the Catholic church’s hold on the population. Among both Catholics and Protestants, witch-hunting became a prime way for attracting and appeasing the masses by demonstrating their Satan-fighting prowess. It was the simple strategy of stoking fears about an outside threat and then assuring people that you, and you alone, can protect them (Sound familiar to politics today?). This concept goes a long way toward explaining not just why witch-hunting mania exploded in Europe, but also why it took hold where it did: Germany. The context here is best summarized by Voltaire, who famously remarked that the Holy Roman Empire was “neither holy, nor Roman, nor an empire”. This implies that the HRE was weakened, and due to a decentralized structure, enforcing Catholicism and rooting out Protestantism was much harder (Guilford). Given this new hostility towards witches, when texts such as the witch-hunting textbook “Malleus Maleficarum” connected witches to the previously mentioned flying ointments along with other completely bizarre rituals (Larkin), it is clear to see how psychedelics were caught in the crossfire of the churches. By defining the position of witches in society, they also defined the narrative on psychedelics.',
            '$L/imgs/med_img_4.jpeg@Confessional-battle and witch-trial activity between 1300 and 1850~https://cms.qz.com/wp-content/uploads/2018/01/chart-leeson-russ-colorcorrected.jpeg?quality=75&strip=all&w=620&h=398&crop=1',
    ...
    },
    {
        ...
        content: [
            ...
            'It is no secret that the common European view of the time of indigenous people was that they were inferior culturally, technologically, and religiously (Szalay). The Spanish conquistadors were essentially sanctioned pirates. Their goals primarily focused on stealing wealth for their country and civilizing the natives with Catholicism. Spain hoped to pacify areas that held extractable natural resources such as iron, tin, copper, salt, silver, gold, etc. They did however, also just want to spread Catholicism (Gallagher et al.). In the papal bull of 1508, Universalis Ecclesiae (Of the Universal Church), Pope Julius II declared that the king of Spain would be the head of the Church in Spain and its empire. Such an empowerment clearly meant that along with Spanish law, governance, language, and culture, the Roman Catholic religion, too, would cross from Europe to the Americas and that the king of Spain would engage in the spread of Christianity to the native peoples of the New World (Sánchez). Thus, while not just for the sake of making the locals subservient to them, there clearly was an economic motive behind the religious conversion. Bringing this context of motivation into the picture tells us why the Spanish Missionaries did what they did. Seeing the natives partake in the use of psychedelics, something the Church considered heresy, served as yet another avenue where they could displace the local culture and religion, and squeeze the natives into the mold of Spanish culture.',

            '$/imgs/az_img_4.jpeg@The Erection of the First Cross, from Historia de Tlaxcala by Diego Munoz Camargo~https://www.meisterdrucke.uk/fine-art-prints/Mexican-School/427534/Ms-Hunter-242-f.239v-The-Erection-of-the-First-Cross,-from-Historia-de-Tlaxcala-by-Diego-Munoz-Camargo-.html$/imgs/az_img_5.jpeg@Compulsory Conversion of Native Americans to Christianity by Spanish Jesuit Missionaries, c.1500~https://thesaltcollective.org/christopher-columbus-brought-white-supremacy-to-america/',

            'There is a striking parallel here to what the Church did back in the Old World (see section "Medieval Europe"). Once again, the compound history of psychedelics was tied to and shaped by authorities with the ambition of power. Of course, this time the scale was powerful armies invading a foreign land, and if not for the diseases the Europeans brought over with them, who knows how things would have played out (Gallagher et al.). Ultimately, this setting gives us context on several important events that shaped history. Apart from the cultural genocide and death of millions of natives, we see how the compound history of psychedelics changed forever, as their use in the Misoamerica was driven underground and forgotten by the west, waiting to someday be rediscovered.'
        ]
    ...
    },
    {
        ...
        content: [
            ...
            'The problem with self-experimentation and lack of clear consent is it allows for conflict of interest and induces a chemical gaze where scientists are trained to see only the scientific results of the experiment, rather than the diversity of psychedelics (Landecker). This happened numerous times during the “peyote boom” as the scientists focused on the outcomes of the experiments and did not consider the substance having other uses. For example, Ellis tried to consider other uses of peyote, but ended up dismissing the views of Indigineuos cultures, saying that it gave no insight powers or physiological effects that they claimed it had. Indigineous people also used peyote as a medicine and said that it provided visions from the gods. Ellis dismissed all of this without speaking to members of this community. These effects and attitudes did not stop with the “peyote boom”. In fact these chemical gazes cemented themselves among scientists like Albert Hofmann and those from the Nazi Regime.',
    ...
    },
    {
        ...
        content: [
            ...
            '$imgs/lsd_img_1.jpeg@Albert Hofmann Holds a Model of an LSD Molecule~ https://www.nature.com/articles/497435a$imgs/lsd_img_2.jpeg@LSD: My Problem Child: Reflections on Sacred Drugs, Mysticism and Science~https://www.thebookmerchantjenkins.com/product/lsd-my-problem-child-reflections-on-sacred-drugs-mysticism-and-science-2/',
            ...
            '$Limgs/lsd_img_3.jpeg@Example of Rye with Ergot~https://www.foodsafetynews.com/2021/09/europe-sets-new-ergot-alkaloids-limits/',
            ...
            '$Limgs/lsd_img_4.jpeg@Blomerth, Brian. “Bicycle Day”~ https://www.latimes.com/books/la-ca-jc-bicycle-day-brian-blomerth-lsd-history-20190626-story.html',
            ...
            '| Secret’s Out (Sharing the Discovery of LSD with the Scientific Community)',
            ...
            '$imgs/lsd_img_5.jpeg@Original Bottle of Delysid - Manufactured by Sandoz Pharmaceuticals~ https://mappingignorance.org/2017/06/07/lsd-therapeutic-agent-autism/',
            ...
            '$Limgs/lsd_img_6.jpeg@Timothy Leary~https://www.britannica.com/biography/Timothy-Leary',
    ...
    },
    {
        ...
        content: [
            ...
            '$Limgs/cc_img_1.png@Manufactured to be inexpensive, LSD being sold for 1.00 USD~https://hippiehate.weebly.com/drug-use.html',
            ...
            '$Limgs/cc_img_2.png@A person at an anti-war protest sporting a classic phrase~https://synergeticpress.com/blog/consciousness-and-psychedelics/summer-of-love-sale-lsd-1960s-counterculture/',
            
            'In a 1994 admission by Nixon’s Assistant to the President for Domestic Affairs (Watergate co-conspirator), John Ehrilchman, bluntly stated that the “Nixon campaign… had two enemies: the antiwar left and black people,” strategizing that “by getting the public to associate the hippies with marijuana and blacks with heroin, and then criminalizing both heavily, we could disrupt those communities.” Finally, to drive it home: “Did we know we were lying about the drugs? Of course we did” (Beres, 2020). All evidence demonstrates psychedelic criminalization as an act of chemical governance. Moreover, knowing psychedelics have proven therapeutic benefits, this targeting of psychedelics (among other drugs) was almost exclusively in the name of political strategy.',

            '$Limgs/cc_img_3.jpeg@Richard Nixon delivers a 1971 speech addressing the war on drugs, labeling it a “national emergency”~https://hippiehate.weebly.com/drug-use.html',
            
            'The government response to psychedelic use was a gradual crackdown; psychedelics were classified as Schedule I substances in Nevada and California in 1966, criminalization becoming more widespread over the next couple decades. Psychedelics were even listed as being addictive and without therapeutic benefit, despite emerging research demonstrating the opposite (DEA Drug Fact Sheet). The government took advantage of the fear and stigma surrounding these drugs generated by their symptomatology: feeling out of control or crazy, including cases where psychotic states were triggered in those with underlying conditions (Hyde, 1978). In fact, some argue that our colonial, Western view of Indigenous psychedelic use has been far too romanticized and twisted in such a way that damages the palatability of healthy, accepted psychedelic use (Fotiou, 2016).',

            'Prominent activists emerged in popular culture during this time, including Aldous Huxley, Alan Watts, and Terence McKenna. People like them spearheaded the psychedelic revolution, believing that psychedelic experiences are effective in helping the user address existential questions, plugging them into an existence that is transcendental. Extensions of their beliefs are that the ritual has become lost in our consumerist society, and that our salvation is through a pushback in our perspectives and perceptions of the world (Fotiou, 2019). In tandem with the Western, colonial scientific lens, people bought into tribal ideas, propagating messages of Indigenous appropriation in an effort to locate our humanity and to rethink the West’s relationship with others, itself, and the spiritual. Activists point out why psychedelics were made illegal: these experiences rewire the brain, triggering the user to step outside of their mind-bubble to challenge long standing assumptions about culture, human nature, and the universe. At this point in history, however, the Western extraction of psychedelics from their sacramental context mirrored similar colonial acts, like the appropriation of malaria drug quinine from South American tribal practices involving cinchona bark (Crawford 2016). In the end, the scientific cultural filter rejected the idea that psychedelics could be stably used as entheogens.'
        ]

    },
    {
        title: 'Present Day: Research and Regulation',
        time: '2000 - Now',
        bg: '/imgs/pd_bg.jpeg',
        content: [
            'Ever since the synthesis of LSD and the subsequent cultural fascination with psychedelics, there has been a notable emphasis on thinking about these drugs scientifically. Throughout much of the ‘80s, ‘90s, and early 2000s, there were numerous accounts of people being arrested for their labs where they were growing, cultivating, synthesizing, and manufacturing psychedelics. However, even though many of these people were well known individuals (and their arrests were publicized), there were still books, articles, and documentaries released on the benefits of these drugs, even including guides for growing and synthesizing your own. While psychedelics were forcefully put on the backburner by the government, this was an important stretch of time during which perceptions began to move away from the entheogenic volatility of the counterculture movement (Tom Frame, Psychedelic Timeline).',
            ...
            '$Limgs/pd_img_5.jpeg@A psychedelic art piece demonstrating therapeutic benefits among other dazzling effects~https://www.newscientist.com/article/mg23631530-300-mind-menders-how-psychedelic-drugs-rebuild-broken-brains/',

            'There is a lively effort to decriminalize and integrate these substances safely into our culture, especially with growing demands to innovate our treatment system for mental health. These events are even reflected in popular culture; there is an apparent renaissance on our hands—psychedelics have been the focus of many books, documentaries, and podcasts. For example, the documentary Fantastic Fungi was recently released and discusses recreational, therapeutic, and spiritual use of mushrooms.',

            '$imgs/pd_img_6.jpeg@ The movie cover for Fantastic Fungi, a documentary addressing research, advocacy, recreation, and mysticality.~ https://watch.fantasticfungi.com/'
...
export const themes = [
    {
        ...
        content: [
            ...
            'Psychedelic governance, in the Present Day, has been a slow evolution from strictly criminalized drugs to highly regulated research medicine. The dust from the counterculture movement had settled, and, heavily motivated by the mental health crisis, scientists were eventually allowed once again to pursue studies using psychedelics as therapeutic tools. With growing credible evidence of the benefits of psychedelics, a subtle renaissance has been influencing city and state U.S. legislation, leading to the 2020 state-funded legalization and facilitation of psilocybin therapy in Oregon. The future of psychedelics in the West will likely be marked by cautious monitoring from the government as society mulls over the potential in letting go of its drug and mental health stigmas.',
    ...
    },
    {
        ...
        content: [
            ...
            'As recently as the 1960s, we can trace how specific actors, like mainstream news outlets hungry for sensational content and self-proclaimed gurus of psychedelics, prematurely propelled psychedelic substances into the public eye. In a Western context, till this point psychedelics had been closely confined to scientific circles. Scientists in contact with the substances did so with little caution for psychedelics’ capacity for harm as they let curiosity and a need for a replacement drug drive their actions. In the late 1800’s we see the “peyote boom”, where scientists like John Briggs and Henry Ellis freely tested psychedelics on themselves in order to see what the effects were. Psychedelics were hard to come by during this time and were mainly used by scientists as they looked for new non-addictive medications. We see this again in WWII and its aftermath, where Nazi scientists and the CIA freely tested psychedelics on prisoners and enemies. This is before these drugs had reached the public as they were now being used to find a truth serum for interrogation and torture techniques. ',
    ...
    },
    {
        ...
        content: [
            ...
            'This trend was seen in Western perceptions of Indigenous Communities of Central Mexico in the 1950s. Shortly after the release of “Seeking the Magic Mushroom”, “Westerners began tripping to Oaxaca and scarfing up shrooms” (Teresi). Wasson’s publication depicted these mushrooms in an exotic and fascinating light, effectively presenting them as potential recreational drugs. How did Wasson’s writing present hallucinogenic mushrooms in this manner? The article contained notable sections written in an adventure fiction, “Indiana Jones-esque” style. For example, Wasson recalled laboring “up a ravine through the heavy, moist heat” and asking a Mixteco guide, “Will you help me learn the secrets of the divine mushroom?” (Wasson 102). In this style, Wasson ascribes a certain “mystical mentor” archetype to the Mixteco individual, making him (and as an extension, the Mixtec people), a feature of a larger adventure story. This depiction built on existing Western attitudes toward American Inginenous communities - one that stereotypically assumed them to be “exotic” or “remnants of the ancient past.” In this context, mushrooms, which were used in religious rites by the Mixtec, assumed the identity of its users - an identity invented by Western-centric notions. The idea that mushrooms were “exotic” or “divine” made them considerably alluring for Westerner’s seeking adventure and fun. Thus, the mushroom’s adoption of a Western-derived Mixtec identity, as well as being contextualized in an adventure-esque setting, may explain their subsequent popularization in the Western world.',

            'In addition, this theme can be seen in the Counterculture Movement of the 1960s and 70s, and in the Cold War. Specifically, this theme appears in the interaction between LSD, hippies, and Cold War propaganda, and offers an interesting example of how both psychedelics and its users can influence each other’s public perception. In order to suppress the voices of hippies and other deviant populations, the U.S. government employed media campaigns to purposefully stigmatize LSD. Erich Goode, a sociologist from SUNY Stony Brook, provides several examples of when the media claimed that “LSD use [can] cause chromosome damage” despite a lack of scientific verification (Goode 536). Goode describes this campaign as a “moral panic” because the media’s concern was severely disproportionate to the actual effects of LSD. (Goode 539). The effort to criminalize LSD may have been motivated by the desire to suppress anti-war and other deviant ideologies largely held by hippie communities. Psychedelics, which were known to be used characteristically by hippies, became a convenient tool to marginalize and discredit their voices (DiPaolo). In this way, in the eyes of the American public, hippies adopted the negative stigmas of LSD - stigmas mediated by the sensationalized claims of mass media. At the same time, while these stigmas shifted to hippies, the existing hostility toward these people transferred back to LSD. This outward hostility was likely a result of the hippies\' own hostility toward established institutions - institutions which were largely comprised by the general public. Ultimately, LSD and hippies mutually assumed each other\'s perceptions, powered by Cold War proponents with an agenda to suppress divergent sentiments.',
    ...
    },
    {
        ...
        content: [
            ...
            'This recent movement contests perceptions of psychedelics forged during the ‘60s and ‘70s Flesh of the Devil period, during which psychedelics were seen as dangerous and were associated with anti-war hippies; thus, a panicked government backlash was sparked, eventually leading to the legal classification of psychedelics as “addictive” schedule I substances. In retrospect, we are seeing more that this criminalization was largely a political power grab that hindered mental health treatment and fed into damaging stigmas.',
            
            'The West has had a controversial, almost cyclic relationship with psychedelics. As discussed in Indigenous Tribes, psychedelics were originally perceived as entheogens: substances used to bring forth the divine from within. Now, we cannot help but view them through a scientific lens —we disregard, or appropriate, refined Indigenous practices in which psychedelics use was free of stigma, utilized for healing and spiritual guidance.',
            
            'Present Day research is primarily focused on developing better treatments for mental disorders including PTSD, substance use disorder, depression, and anxiety. This is human-centered research, but the academic setting is growing slowly, limited in approval and funding and underdeveloped in paradigmatic approach. Future focus will narrow in on the mystical experiences themselves that are richly complex and ripe with opportunity for research in both culture and the brain. The end result may yet be an intertwinement of science and spirituality.',
